...
const Envelope = (props) => (
  <svg
    ...
    fill="currentColor"
    className="icon icon__form bi bi-envelope-open"
    viewBox="0 0 16 16"
  >
...
const PersonFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="icon icon__form  bi bi-person-circle"
    viewBox="0 0 16 16"
  >
...
const CheckMark = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="icon icon__success bi bi-check-circle-fill"
    viewBox="0 0 16 16"
  >
...
const Access = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="icon icon__success bi bi-eye-slash-fill"
    viewBox="0 0 16 16"
  >
...
const SearchIcon = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="icon icon__search bi bi-search"
    viewBox="0 0 16 16"
  >
...
const Wifi = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="icon icon__spec bi bi-wifi"
    viewBox="0 0 16 16"
  >
...
const Cup = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="icon icon__spec bi bi-cup"
    viewBox="0 0 16 16"
  >
...
const Location = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="icon icon__spec bi bi-geo"
    viewBox="0 0 16 16"
  >
    <path
      fillRule="evenodd"
